...
console.log('%s pokemon in the database.', pokemonDatabase.length);
pokemonDatabase = pokemonDatabase.filter(p => fs.existsSync('public/img/pokemon/' + p.id +  '.png'));
console.log('%s pokemon in the database with actual images.', pokemonDatabase.length);

module.exports = {

  getRandomIndex() {
    return parseInt(Math.random() * pokemonDatabase.length);
  },

  getRandomPokemon() {
    return pokemonDatabase[this.getRandomIndex()];
  }
